...
public class BarberApprovalDetails extends Activity {
    Button btnApproval;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.barber_approval_details);
        ...
        btnApproval.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mDatabase.child(barberID).child("status").setValue(true);
                Intent intent = new Intent(BarberApprovalDetails.this, MainActivity.class);
